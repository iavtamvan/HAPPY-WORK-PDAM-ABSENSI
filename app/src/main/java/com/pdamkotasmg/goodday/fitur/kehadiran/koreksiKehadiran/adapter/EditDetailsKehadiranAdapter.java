...
public class EditDetailsKehadiranAdapter extends RecyclerView.Adapter<EditDetailsKehadiranAdapter.ViewHolder> {
    Context context;
    ...
    public EditDetailsKehadiranAdapter(Context context, List<DataItem> dataItems) {
...
//                Log.d(TAG, "dateServerPostman: " + dateServerPostman);
                editDetailsKehadiranAdapter = new EditDetailsKehadiranAdapter(context, dataItems);
