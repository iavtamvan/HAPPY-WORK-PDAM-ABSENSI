...
public class RiwayatPerjalananDinasAdapter extends RecyclerView.Adapter<RiwayatPerjalananDinasAdapter.ViewHolder> {
    Context context;
    private List<DataItem> dataItems;

    private String reason;

    public RiwayatPerjalananDinasAdapter(Context context, List<DataItem> dataItems) {
