...
public class EditDetailsLemburAdapter extends RecyclerView.Adapter<EditDetailsLemburAdapter.ViewHolder> {
    Context context;
    ...
    public  EditDetailsLemburAdapter(Context context, List<DataItem> dataItems) {
...
//                Log.d(TAG, "dateServerPostman: " + dateServerPostman);
                editDetailsKehadiranAdapter = new EditDetailsLemburAdapter(context, dataItems);
