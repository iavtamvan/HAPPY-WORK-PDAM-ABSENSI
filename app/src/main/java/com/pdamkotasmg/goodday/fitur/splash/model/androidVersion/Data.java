package com.pdamkotasmg.goodday.fitur.splash.model.androidVersion;

import com.google.gson.annotations.SerializedName;

public class Data{

    @SerializedName("android-token-5")
    private String androidToken5;

    @SerializedName("android-token-3")
    private String androidToken3;

    @SerializedName("android-version-latest")
    private String androidVersionLatest;

    @SerializedName("android-token-2")
    ...
    @SerializedName("android-token-1")
    ...
    public void setAndroidToken5(String androidToken5){
        this.androidToken5 = androidToken5;
    }

    public String getAndroidToken5(){
        return androidToken5;
    }

    public void setAndroidToken3(String androidToken3){
        this.androidToken3 = androidToken3;
    }

    public String getAndroidToken3(){
        return androidToken3;
    }
    ...
    public void setAndroidToken2(String androidToken2){
        this.androidToken2 = androidToken2;
    }

    public String getAndroidToken2(){
        return androidToken2;
    }
    ...
    public void setAndroidToken1(String androidToken1){
        this.androidToken1 = androidToken1;
    }

    public String getAndroidToken1(){
        return androidToken1;
    }
