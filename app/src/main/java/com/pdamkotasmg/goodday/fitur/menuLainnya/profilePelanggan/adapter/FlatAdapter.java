...
public class FlatAdapter extends RecyclerView.Adapter<FlatAdapter.ViewHolder> {
    ...
    private List<FlatItem> dataItems;

    public FlatAdapter(Context context, List<FlatItem> dataItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_flat, parent, false);
