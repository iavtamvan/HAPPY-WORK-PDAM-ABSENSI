...
public class PersetujuanAdapter extends RecyclerView.Adapter<PersetujuanAdapter.ViewHolder> {
    Context context;
    private List<DataItem> dataItems;

    public PersetujuanAdapter(Context context, List<DataItem> dataItems) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (dataItems.get(position).getApprovalStatusCode().equalsIgnoreCase("REJECTED")) {
        ...
        } else if (dataItems.get(position).getApprovalStatusCode().equalsIgnoreCase("WAITING")) {
            holder.divRequestWaiting.setVisibility(View.VISIBLE);
            holder.divRequestDisetujui.setVisibility(View.GONE);
            holder.divRequestDitolak.setVisibility(View.GONE);
            holder.divRequestCancel.setVisibility(View.GONE);
        } else if (dataItems.get(position).getApprovalStatusCode().equalsIgnoreCase("APPROVED")) {
