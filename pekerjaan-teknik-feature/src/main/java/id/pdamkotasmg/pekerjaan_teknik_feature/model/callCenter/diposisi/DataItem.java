package id.pdamkotasmg.pekerjaan_teknik_feature.model.callCenter.diposisi;
...
public class DataItem{
    ...
    private String idKategoriCc;

    @SerializedName("id_subbag_cc")
    private String idSubbagCc;

    @SerializedName("dilihat_oleh")
    private String dilihatOleh;
    ...
    public void setNoPengaduanAndro(String noPengaduanAndro){
        this.noPengaduanAndro = noPengaduanAndro;
    }

    public String getNoPengaduanAndro(){
    ...
    public void setIdMediaCc(String idMediaCc){
        this.idMediaCc = idMediaCc;
    }

    public String getIdMediaCc(){
        return idMediaCc;
    }

    public void setDilihatWaktu(String dilihatWaktu){
        this.dilihatWaktu = dilihatWaktu;
    }

    public String getDilihatWaktu(){
        return dilihatWaktu;
    }
    ...
    public void setTagihanBlnIni(String tagihanBlnIni){
        this.tagihanBlnIni = tagihanBlnIni;
    }

    public String getTagihanBlnIni(){
    ...
    public void setTglRecek(String tglRecek){
        this.tglRecek = tglRecek;
    }

    public String getTglRecek(){
        return tglRecek;
    }
    ...
    public void setTarifPelanggan(String tarifPelanggan){
        this.tarifPelanggan = tarifPelanggan;
    }

    public String getTarifPelanggan(){
    ...
    public void setStandLalu(String standLalu){
        this.standLalu = standLalu;
    }

    public String getStandLalu(){
        return standLalu;
    }
    ...
    public void setJmlTunggakan(String jmlTunggakan){
        this.jmlTunggakan = jmlTunggakan;
    }

    public String getJmlTunggakan(){
        return jmlTunggakan;
    }
    ...
    public void setIdDisposisiCc(String idDisposisiCc){
        this.idDisposisiCc = idDisposisiCc;
    }

    public String getIdDisposisiCc(){
    ...
    public void setIdKategoriCc(String idKategoriCc){
        this.idKategoriCc = idKategoriCc;
    }

    public String getIdKategoriCc(){
        return idKategoriCc;
    }

    public void setIdSubbagCc(String idSubbagCc){
        this.idSubbagCc = idSubbagCc;
    }

    public String getIdSubbagCc(){
        return idSubbagCc;
    }

    public void setDilihatOleh(String dilihatOleh){
        this.dilihatOleh = dilihatOleh;
    }

    public String getDilihatOleh(){
        return dilihatOleh;
    }
