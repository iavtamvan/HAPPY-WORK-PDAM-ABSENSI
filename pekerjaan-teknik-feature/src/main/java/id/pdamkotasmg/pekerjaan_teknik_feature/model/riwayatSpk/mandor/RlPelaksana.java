...
public class RlPelaksana{
    ...
    @SerializedName("stlembur")
    private String stlembur;
    ...
    @SerializedName("rl_m_barang")
    private RlMBarang rlMBarang;
    ...
    public void setStlembur(String stlembur){
        this.stlembur = stlembur;
    }

    public String getStlembur(){
        return stlembur;
    }
    ...
    public void setTglUpdate(Object tglUpdate){
        this.tglUpdate = tglUpdate;
    }

    public Object getTglUpdate(){
        return tglUpdate;
    }

    public void setRlMBarang(RlMBarang rlMBarang){
        this.rlMBarang = rlMBarang;
    }

    public RlMBarang getRlMBarang(){
        return rlMBarang;
    }
