package id.pdamkotasmg.pekerjaan_teknik_feature.model.riwayatSpk.verifikator;
...
public class DataItem{
    ...
    public void setRlSpk(RlSpk rlSpk){
        this.rlSpk = rlSpk;
    }

    public RlSpk getRlSpk(){
        return rlSpk;
    }
