package id.pdamkotasmg.pekerjaan_teknik_feature.activity.spk.search;
...
import id.pdamkotasmg.pekerjaan_teknik_feature.adapter.BarangDikerjakanAdapter;
import id.pdamkotasmg.pekerjaan_teknik_feature.adapter.BarangTambahanAdapter;
import id.pdamkotasmg.pekerjaan_teknik_feature.adapter.PengawasAdapter;
import id.pdamkotasmg.pekerjaan_teknik_feature.adapter.SPKSebelumnyaAdapter;
import id.pdamkotasmg.pekerjaan_teknik_feature.adapter.ZonaAdapter;
...
import id.pdamkotasmg.pekerjaan_teknik_feature.model.barang.DataItem;
...
public class SearchPengawasActivity extends AppCompatActivity {
    ...
    private List<id.pdamkotasmg.pekerjaan_teknik_feature.model.pegawai.DataItem> dataItem = new ArrayList<>();
    private PengawasAdapter pengawasAdapter;

    private List<DataItem> dataItemBarang = new ArrayList<>();
    private BarangDikerjakanAdapter barangDikerjakanAdapter;
    private BarangTambahanAdapter barangTambahanAdapter;

    private List<id.pdamkotasmg.pekerjaan_teknik_feature.model.spk.DataItem> dataItemSPK = new ArrayList<>();
