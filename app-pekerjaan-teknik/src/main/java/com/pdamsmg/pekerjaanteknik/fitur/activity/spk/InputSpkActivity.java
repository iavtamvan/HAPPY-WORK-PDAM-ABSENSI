...
import com.pdamsmg.pekerjaanteknik.adapter.postData.BarangTambahanListAdapter;
import com.pdamsmg.pekerjaanteknik.adapter.postData.PekerjaanTambahanAdapter;
import com.pdamsmg.pekerjaanteknik.api.ApiConfig;
import com.pdamsmg.pekerjaanteknik.api.ApiService;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.riwayat.RiwayatSpkActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.search.SearchPengawasActivity;
import com.pdamsmg.pekerjaanteknik.model.listAll.AsalItem;
import com.pdamsmg.pekerjaanteknik.model.listAll.JenisPekerjaanItem;
import com.pdamsmg.pekerjaanteknik.model.listAll.ListAllGabunganRootModel;
import com.pdamsmg.pekerjaanteknik.model.listAll.PekerjaanDikerjakanItem;
import com.pdamsmg.pekerjaanteknik.model.listAll.StatusPenyelesaianItem;
import com.pdamsmg.pekerjaanteknik.model.listAll.TenagaItem;
import com.pdamsmg.pekerjaanteknik.model.post.postRoot.ListBarangItem;
import com.pdamsmg.pekerjaanteknik.model.post.postRoot.ListBarangLocalItem;
import com.pdamsmg.pekerjaanteknik.model.post.postRoot.ListPekerjaanItem;
import com.pdamsmg.pekerjaanteknik.model.post.responseReuired.ResponseReqRootModel;
import com.pdamsmg.pekerjaanteknik.model.tagihan.BillingTagihanRootModel;
...
//                    Toast.makeText(context, "! finding", Toast.LENGTH_SHORT).show();
        ...
        rgLembur.setOnCheckedChangeListener((group, checkedId) -> {
            switch (checkedId) {
                case R.id.rb_ya_lembur:
                    kodeLembur = "1";
                    break;
                case R.id.rb_tidak_lembur:
                    kodeLembur = "0";
                    break;
            }
        });
...
//        RequestBody tgl_selesai = RequestBody.create(MediaType.parse("text/plain"), tvTglPelaksanaan.getText().toString().trim());
        ...
        apiService.postDatasSPK2(token, tgl_pelaksana, jam1, jam2, jenis_pipa, diameter, tekanan, uraian, jml_tenaga, jml_tenaga_ket, kasub, pengawas, ip_entry, pc_entry, status,
                        ...
                        list_pekerjaan, bodyFoto1, bodyFoto2, bodyFoto3, bodyFoto4, kd_jns, no_pengaduan_cc, no_aduan, penyelesaian, status_kode_cc, st_lembur, user_ver)
                .enqueue(new Callback<ResponseReqRootModel>() {
                    ...
                    public void onResponse(Call<ResponseReqRootModel> call, Response<ResponseReqRootModel> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(InputSpkActivity.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
