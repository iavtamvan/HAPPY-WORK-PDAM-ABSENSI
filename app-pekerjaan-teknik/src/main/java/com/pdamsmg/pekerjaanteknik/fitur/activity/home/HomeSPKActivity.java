...
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.VerifikasiActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.callCenter.DaftarCallCenterActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.riwayat.RiwayatAmbilPekerjaanActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.riwayat.RiwayatSpkActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.spk.riwayat.RiwayatVerifikasiActivity;
import com.pdamsmg.pekerjaanteknik.fitur.activity.webView.WebViewActivity;
...
//            finishAffinity();
//            Toast.makeText(this, "Not Supported Android 12 x004423 javLang:unsupportedOsVersion " + getSdkVersion, Toast.LENGTH_LONG).show();
//        }
